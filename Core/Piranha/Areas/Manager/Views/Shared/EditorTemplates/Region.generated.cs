...
namespace ASP
{
    ...
    public partial class _Areas_Manager_Views_Shared_EditorTemplates_Region_cshtml_ : System.Web.Mvc.WebViewPage<Piranha.Models.Region>
    {
        public _Areas_Manager_Views_Shared_EditorTemplates_Region_cshtml_()
        {
        }
...
WriteAttribute("class", Tuple.Create(" class=\"", 280), Tuple.Create("\"", 359)
, Tuple.Create(Tuple.Create("", 288), Tuple.Create("region-body", 288), true)
            
            #line 7 "..\..\Areas\Manager\Views\Shared\EditorTemplates\Region.cshtml"
, Tuple.Create(Tuple.Create(" ", 299), Tuple.Create<System.Object, System.Int32>(Model.Body.GetType().Name == "HtmlRegion" ? "fixed" : ""
