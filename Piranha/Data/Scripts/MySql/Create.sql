CREATE TABLE sysuser (
	sysuser_id CHAR(36) NOT NULL,
	sysuser_apikey CHAR(36) NULL,
...
CREATE TABLE sysgroup (
	...
	sysgroup_created_by CHAR(36) NULL,
	sysgroup_updated_by CHAR(36) NULL,
...
CREATE TABLE sysaccess (
	sysaccess_id CHAR(36) NOT NULL,
	sysaccess_group_id CHAR(36) NOT NULL,
	...
	sysaccess_created_by CHAR(36) NULL,
	sysaccess_updated_by CHAR(36) NULL,
...
CREATE TABLE sysparam (
	...
	sysparam_created_by CHAR(36) NULL,
	sysparam_updated_by CHAR(36) NULL,
...
CREATE TABLE syslog (
	syslog_id CHAR(36) NOT NULL,
	syslog_parent_id CHAR(36) NOT NULL,
	...
	syslog_created_by CHAR(36) NOT NULL,
	syslog_updated_by CHAR(36) NOT NULL,
...
CREATE TABLE namespace (
	...
	namespace_created_by CHAR(36) NOT NULL,
	namespace_updated_by CHAR(36) NOT NULL,
...
CREATE TABLE sitetree (
	sitetree_id CHAR(36) NOT NULL,
	sitetree_namespace_id CHAR(36) NOT NULL,
	sitetree_internal_id VARCHAR(32) NOT NULL,
	sitetree_name VARCHAR(64) NOT NULL,
	sitetree_description VARCHAR(255) NULL,
	sitetree_meta_title VARCHAR(128) NULL,
	sitetree_meta_description VARCHAR(255) NULL,
	sitetree_hostnames TEXT NULL,
	sitetree_created DATETIME NOT NULL,
	sitetree_updated DATETIME NOT NULL,
	sitetree_created_by CHAR(36) NOT NULL,
	sitetree_updated_by CHAR(36) NOT NULL,
...
CREATE TABLE permalink (
	permalink_id CHAR(36) NOT NULL,
	permalink_namespace_id CHAR(36) NOT NULL,
	...
	permalink_created_by CHAR(36) NOT NULL,
	permalink_updated_by CHAR(36) NOT NULL,
...
CREATE TABLE pagetemplate (
	pagetemplate_id CHAR(36) NOT NULL,
	...
	pagetemplate_view CHAR(128) NULL,
	pagetemplate_view_show BIT NOT NULL default false,
	pagetemplate_redirect VARCHAR(128) NULL,
	pagetemplate_redirect_show BIT NOT NULL default false,
	pagetemplate_site_template BIT NOT NULL default false,
	pagetemplate_type VARCHAR(255) NULL,
	pagetemplate_created DATETIME NOT NULL,
	pagetemplate_updated DATETIME NOT NULL,
	pagetemplate_created_by CHAR(36) NOT NULL,
	pagetemplate_updated_by CHAR(36) NOT NULL,
...
CREATE TABLE posttemplate (
	posttemplate_id CHAR(36) NOT NULL,
	posttemplate_permalink_id CHAR(36) NULL,
	...
	posttemplate_view CHAR(128) NULL,
	posttemplate_view_show BIT NOT NULL default false,
	...
	posttemplate_type VARCHAR(255) NULL,
	posttemplate_created DATETIME NOT NULL,
	posttemplate_updated DATETIME NOT NULL,
	posttemplate_created_by CHAR(36) NOT NULL,
	posttemplate_updated_by CHAR(36) NOT NULL,
...
CREATE TABLE category (
	...
	category_parent_id CHAR(36) NULL,
	category_permalink_id CHAR(36) NOT NULL,
	category_name VARCHAR(64) NOT NULL,
	category_description VARCHAR(255) NULL,
	category_created DATETIME NOT NULL,
	category_updated DATETIME NOT NULL,
	category_created_by CHAR(36) NOT NULL,
	category_updated_by CHAR(36) NOT NULL,
...
CREATE TABLE relation (
	...
	relation_data_id CHAR(36) NOT NULL,
	relation_related_id CHAR(36) NOT NULL,
	CONSTRAINT pk_relation_id PRIMARY KEY (relation_id, relation_draft)
);

CREATE TABLE page (
	page_id CHAR(36) NOT NULL,
	page_sitetree_id CHAR(36) NOT NULL,
	page_original_id CHAR(36) NULL,
	page_draft BIT NOT NULL default true,
	page_template_id CHAR(36) NOT NULL,
	page_group_id CHAR(36) NULL,
	page_group_disable_id TEXT NULL,
	page_parent_id CHAR(36) NULL,
	page_permalink_id CHAR(36) NOT NULL,
	...
	page_created_by CHAR(36) NOT NULL,
	page_updated_by CHAR(36) NOT NULL,
...
CREATE TABLE regiontemplate (
	regiontemplate_id CHAR(36) NOT NULL,
	regiontemplate_template_id CHAR(36) NOT NULL,
	...
	regiontemplate_created_by CHAR(36) NOT NULL,
	regiontemplate_updated_by CHAR(36) NOT NULL,
...
CREATE TABLE property (
	...
	property_parent_id CHAR(36) NOT NULL,
	property_name VARCHAR(64) NOT NULL,
	property_value TEXT NULL,
	property_created DATETIME NOT NULL,
	property_updated DATETIME NOT NULL,
	property_created_by CHAR(36) NOT NULL,
	property_updated_by CHAR(36) NOT NULL,
...
CREATE TABLE post (
	...
	post_permalink_id CHAR(36) NOT NULL,
	...
	post_created_by CHAR(36) NOT NULL,
	post_updated_by CHAR(36) NOT NULL,
...
CREATE TABLE content (
	...
	content_draft BIT NOT NULL default true,
	content_parent_id CHAR(36) NULL,
	content_permalink_id  CHAR(36) NULL,
	...
	content_created_by CHAR(36) NOT NULL,
	content_updated_by CHAR(36) NOT NULL,
...
CREATE TABLE upload (
	...
	upload_created_by CHAR(36) NOT NULL,
	upload_updated_by CHAR(36) NOT NULL,
...
CREATE TABLE extension (
	...
	extension_parent_id CHAR(36) NOT NULL,
	...
	extension_created_by CHAR(36) NOT NULL,
	extension_updated_by CHAR(36) NOT NULL,
...
CREATE TABLE comment (
	...
	comment_created_by CHAR(36) NULL,
	comment_updated_by CHAR(36) NULL,
