...
namespace Piranha
{
	...
	public sealed class Db : DbContext
	{
		...
		public DbSet<Data.Extension> Extensions { get; set; }
		...
		protected override void OnModelCreating(DbModelBuilder mb) {
			...
			#region Extension
			mb.Entity<Data.Extension>().ToTable("extension");
			mb.Entity<Data.Extension>().HasKey(p => new { p.Id, p.IsDraft });
			mb.Entity<Data.Extension>().Property(p => p.Id).HasColumnName("extension_id");
			mb.Entity<Data.Extension>().Property(p => p.IsDraft).HasColumnName("extension_draft");
			mb.Entity<Data.Extension>().Property(p => p.ParentId).HasColumnName("extension_parent_id");
			mb.Entity<Data.Extension>().Property(p => p.Body).HasColumnName("extension_body");
			mb.Entity<Data.Extension>().Property(p => p.CLRType).HasColumnName("extension_type").HasMaxLength(255).IsRequired();
			mb.Entity<Data.Extension>().Property(p => p.Created).HasColumnName("extension_created");
			mb.Entity<Data.Extension>().Property(p => p.Updated).HasColumnName("extension_updated");
			mb.Entity<Data.Extension>().Property(p => p.CreatedById).HasColumnName("extension_created_by");
			mb.Entity<Data.Extension>().Property(p => p.UpdatedById).HasColumnName("extension_updated_by");
			mb.Entity<Data.Extension>().HasRequired(p => p.CreatedBy).WithMany().WillCascadeOnDelete(false);
			mb.Entity<Data.Extension>().HasRequired(p => p.UpdatedBy).WithMany().WillCascadeOnDelete(false);
			#endregion
