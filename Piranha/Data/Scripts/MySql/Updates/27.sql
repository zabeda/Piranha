...
ALTER TABLE sitetree ADD sitetree_meta_title VARCHAR(128) NULL;
ALTER TABLE sitetree ADD sitetree_meta_description VARCHAR(255) NULL;
ALTER TABLE pagetemplate ADD pagetemplate_site_template INT NOT NULL default '0';
